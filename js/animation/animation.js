$(document).ready(function () {
    ...
    if ($("body").data("title") === "passions") {
        //Image 6
        //Mouse Over animation => animateStackedImages()
        $('#top__image__6').on('mouseover', function () {

            topImage[5].style.transform = `scale(1.1) rotate(-1deg)`;
            topImage[5].style.boxShadow = `-4px 8px 8px 4px rgba(0,0,0,0.35)`;

            bottomImage[5].style.transform = `scale(1.1) rotate(-15deg)`;
            bottomImage[5].style.boxShadow = `-1px 5px 8px 2px rgba(0,0,0,0.35)`;
        });
        $('#bottom__image__6').on('mouseover', function () {
        ...
        //Mouse Out animation => disanimateStackedImages()
        $('#top__image__6').on('mouseout', function () {

            topImage[5].style.transform = `rotate(-5deg)`;
            topImage[5].style.boxShadow = `-2px 5px 8px 2px rgba(0,0,0,0.35)`;

            bottomImage[5].style.transform = `rotate(-8deg)`;
            bottomImage[5].style.boxShadow = `-2px 5px 8px 2px rgba(0,0,0,0.35)`;
        });
        $('#bottom__image__6').on('mouseout', function () {
